...
namespace CoffeeBoilerHeater {
  enum BoilerHeaterState {
    OFF, ON
  };
}
namespace CoffeeIndicator
{
  enum IndicatorState {
    OFF, ON
  };
...
namespace CoffeeMaker
{
   ...
   * on or off.
   */
  void SetBoilerHeaterState(CoffeeBoilerHeater::BoilerHeaterState s);
  /*
   ...
   */
  void SetIndicatorState(CoffeeIndicator::IndicatorState s);
  /*
